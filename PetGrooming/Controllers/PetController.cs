...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        //URL: /Pet/Add
        [HttpPost]
        public ActionResult Add(string PetName, int SpeciesID,Double PetWeight, String PetColor,int PetAge , string PetNotes)
        {
            ...
            string query = "insert into pets (PetName,SpeciesID,PetWeight,PetColor,PetAge,PetNotes) values (@PetName,@SpeciesID,@PetWeight,@PetColor,@PetAge,@PetNotes)";
            ...
            sqlparams[4] = new SqlParameter("@PetAge", PetAge);
        ...
        [HttpPost]
        public ActionResult Update(int id,string PetName,int SpeciesID, double PetWeight, string PetColor,int PetAge )
        {

            /*Debug.WriteLine("I am trying to edit a pet's name to "+PetName+" and change the weight to "+PetWeight.ToString());*/
            string query = "update pets set PetName = @PetName, SpeciesID = @SpeciesID, PetWeight = @Petweight, PetColor = @PetColor, PetAge = @PetAge where PetID = @PetID";
